...
BG = pygame.transform.scale(pygame.image.load(os.path.join(
    "assets", "outer_space_bg.png")), (WIDTH, HEIGHT))
...
class Ship:
    ...
    def cooldown(self):
        """
        Time that allows user to fire lasers again
        """
...
def collide(obj1, obj2):
    """
    A collision function for overlapping of two masks
    based on the offset of their top left coordinates
    """
...
def main():
    ...
    and determines player lives and levels
    """
    run = True
    FPS = 60
    level = 0
...
def main_menu():
    """
    Function for main-menu that begins with a mouse click
    """
    ...
    while run:
        ...
        title_label = title_font.render(
            "Click 'MOUSE' to begin!", 1, (51, 255, 51))
